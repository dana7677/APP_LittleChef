...
data class Recipe(val id:Long, var name:String, var descript:String, var Ingredients:String, var Instructions:String,var TimeToCook:String,var KCalories:String,var ImgUri:String, var done:Boolean)

{
    companion object
    {
        ...
        const val COLUMN_IMGURI="ImgUri"
